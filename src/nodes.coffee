...
exports.Base = class Base
  ...
  variableDeclarationWalk : (opts) ->
    for child in @icedFlattenChildren()
      child.variableDeclarationWalk opts
...
exports.Block = class Block extends Base
  ...
  compileRoot: (o) ->
    ...
    @doVariableDeclarationWalk(o.scope)
...
exports.Comment = class Comment extends Base
  ...
  isTypeComment: () -> @comment.trimStart().startsWith('@type')
...
exports.Assign = class Assign extends Base
  ...
  compilePatternMatch: (o) ->
    ...
    if value.unwrap() not instanceof IdentifierLiteral or @variable.assigns(vvarText)
      assigns.push [
        @makeCode("#{ ref = o.scope.freeVariable 'ref' } = "), vvar...
      ]
      vvar = [@makeCode ref]
      vvarText = ref
...
exports.Code = class Code extends Base
  ...
  compileNode: (o) ->
    ...
    @body.doVariableDeclarationWalk(o.scope)
