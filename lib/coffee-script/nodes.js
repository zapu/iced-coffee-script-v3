...
(function() {
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function(superClass1) {
    ...
    IdentifierLiteral.prototype.compileNode = function(o) {
      ...
      code = this.value === 'this' ? ((ref3 = o.scope.method) != null ? ref3.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.value === BUILTIN_ICED_VER_LITERAL ? "\"iced3\"" : this.value;
