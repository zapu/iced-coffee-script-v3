...
(function() {
  var Access, Arr, Assign, Await, BUILTIN_ICED_VER_LITERAL, Base, Block, BooleanLiteral, Call, Class, Code, CodeFragment, Comment, Defer, Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, IDENTIFIER_STR, IcedRuntime, IdentifierLiteral, If, ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, ImportSpecifierList, In, Index, InfinityLiteral, JS_FORBIDDEN, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList, NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, Op, Param, Parens, PassthroughLiteral, PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, SIMPLENUM, Scope, Slice, Slot, Splat, StatementLiteral, StringLiteral, StringWithInterpolations, SuperCall, Switch, TAB, THIS, TaggedTemplateCall, ThisLiteral, Throw, Try, UTILITIES, UndefinedLiteral, Value, While, YES, YieldReturn, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, iced, isComplexOrAssignable, isLiteralArguments, isLiteralThis, isUnassignable, locationDataToString, merge, multident, quote_funcname_for_debug, quote_path_for_emission, ref1, ref2, require_top_dir, some, starts, strToJavascript, throwSyntaxError, unfoldSoak, utility,
  ...
  exports.Block = Block = (function(superClass1) {
    ...
    Block.prototype.doVariableDeclarationWalk = function(scope) {
      var checkVar, vmap;
      vmap = new Map();
      checkVar = function(name, arg1, assign, read) {
        var block, blockId, cur, level;
        block = arg1.block, blockId = arg1.blockId, level = arg1.level;
        if (cur = vmap.get(name)) {
          if (level < cur.level || (cur.level === level && cur.block !== block)) {
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function(superClass1) {
    ...
    IdentifierLiteral.prototype.compileNode = function(o) {
      var answer, code, ref3, ref4, ref5, ref6;
      ...
      code = this.value === 'this' ? ((ref6 = o.scope.method) != null ? ref6.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.value === BUILTIN_ICED_VER_LITERAL ? "\"iced3\"" : this.value;
  ...
  exports.Value = Value = (function(superClass1) {
    ...
    Value.prototype.variableDeclarationWalk = function(opts) {
      ...
      if (this.isAssignable && (v = this.base.value)) {
        return opts.checkVar(v, opts, null, this);
      }
    };
  ...
  exports.Comment = Comment = (function(superClass1) {
    ...
    Comment.prototype.compileNode = function(o, level) {
      ...
      multiline = indexOf.call(this.comment, '\n') >= 0;
      if (multiline) {
  ...
  exports.Class = Class = (function(superClass1) {
    ...
    Class.prototype.addProperties = function(node, name, o) {
      var acc, assign, base, exprs, func, locData, props;
  ...
  exports.Assign = Assign = (function(superClass1) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, comment, compiledName, found, isValue, j, jsdocComment, k, klass, kls, len1, locData, method, name, properties, prototype, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref3, ref4, ref5, ref6, ref7, ref8, ref9, shouldDeclare, val, varBase;
      this.icedStatementAssertion();
      ...
      jsdocComment = null;
      if (o.comments) {
        locData = (ref15 = this.locationData) != null ? ref15 : this.variable.locationData;
        ref16 = o.comments;
    ...
    Assign.prototype.variableDeclarationWalk = function(opts) {
      var v, varBase;
      if (this.context || this.moduleDeclaration || this.param) {
        return;
      }
      varBase = this.variable.unwrapAll();
      if (typeof varBase.hasProperties === "function" ? varBase.hasProperties() : void 0) {
      ...
      if (v) {
        if (!opts.scope.check(v)) {
          return opts.checkVar(v, opts, this);
        }
      }
    };
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.icedTransform = function() {
      var body, call, code, f, nxt, rhs, tags;
      if (this.isGenerator) {
