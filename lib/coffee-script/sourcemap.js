...
(function() {
  ...
  SourceMap = (function() {
    ...
    SourceMap.prototype.add = function(sourceLocation, generatedLocation, options) {
      ...
      let lineMap = ((base = this.lines)[line] || (base[line] = new LineMap(line)));
    ...
    SourceMap.prototype.generate = function(options, code) {
      var i, j, len, len1, lineMap, lineNumber, mapping, ref, ref1;
      if (options == null) {
        options = {};
      }
      if (code == null) {
    ...
    let VLQ_CONTINUATION_BIT = 1 << VLQ_SHIFT;

    // 0010 0000
    let VLQ_VALUE_MASK = VLQ_CONTINUATION_BIT - 1;
