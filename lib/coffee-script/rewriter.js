  ...
  exports.Rewriter = Rewriter = (function() {
    ...
    Rewriter.prototype.rewriteComments = function() {
      ...
      this.scanTokens(function(token, i, tokens) {
        var endOfLine, fullLine, jsdoc, locationData, next, prev, ref, ref1, ref2, tag, text;
        tag = token[0], text = token[1], locationData = token[2];
        if (tag === 'HERECOMMENT') {
          prev = (ref = tokens[i - 1]) != null ? ref[0] : void 0;
          next = (ref1 = tokens[i + 1]) != null ? ref1[0] : void 0;
          fullLine = false;
          endOfLine = false;
          ...
          jsdoc = (ref2 = text.match(/^@(type|param)/)) != null ? ref2[1] : void 0;
          savedComments.push({
            tag: tag,
            text: text,
