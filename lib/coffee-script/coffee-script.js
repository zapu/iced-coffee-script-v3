...
(function() {
  var Lexer, SourceMap, base64encode, compile, ext, fn1, formatSourcePosition, fs, getSourceMap, helpers, i, icedTransform, len, lexer, parser, path, ref, sourceMaps, sources, vm, withPrettyErrors,
  ...
  exports.ICED_VERSION = (function() {
    var v;
    v = exports.COFFEE_VERSION.split('.').map(function(x) {
      return parseInt(x);
    });
