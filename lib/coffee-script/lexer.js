...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.commentToken = function() {
      var comment, endOfLine, fullLine, here, isFirstToken, jsdoc, match, oneline, ref2, token;
      ...
      if (here) {
        ...
        isFirstToken = this.tokens.length === 0 && this.comments.length === 0;
